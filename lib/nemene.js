...
exports.sortArr = exports.flatten = exports.reduceDigit = exports.frequency = undefined;
...
function ChiSquareGoodnessOfFit(_ref) {
  ...
  var chiSqrTable = function chiSqrTable() {
...
function MannWhitney(_ref) {
  ...
  var indexSortedObs = (0, _util.sortArr)(function (x, y) {
    return x.value > y.value ? 1 : x.value === y.value ? 0 : -1;
  ...
  values.forEach(function (item, i) {
    var indexes = indexSortedObs.map(function (item, i) {
      item['index'] = i;
      return item;
    }).filter(function (a) {
      return a.value === item;
  ...
  var rObs = indexedObs.map(function (x) {
    return x.index;
  });
...
function SiegelTukey(_ref) {
  ...
  var flattenObserved = (0, _util.flatten)(observed);
  var i = flattenObserved.map(function (_, i) {
    return i + 1;
  });
  var n1 = x.length;
  var n2 = y.length;
...
function KruskalWallis(_ref) {
  ...
  values.forEach(function (item, i) {
    var indexes = indexSortedObs.map(function (val, j) {
      val.index = j;
      return val;
    }).filter(function (a) {
      return a.value === item;
