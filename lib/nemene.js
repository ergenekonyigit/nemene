...
var _ChiSquareGoodnessOfFit = __webpack_require__(61);
...
var _simpleStatistics = __webpack_require__(10);
...
function ChiSquareGoodnessOfFit(_ref) {
  ...
  var chiSqrCalc = (0, _simpleStatistics.sum)((0, _from2.default)({ length: c }, function (_, i) {
...
function Levene(_ref) {
  ...
  var c = observed.length;
  var flatObserved = observed.flatten();
  var n = flatObserved.length;
  var ni = (0, _from2.default)({ length: c }, function (_, i) {
    return observed[i].length;
  });
  var meanObserved = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _simpleStatistics.mean)(observed[i]);
  });
  var Z = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _from2.default)({ length: ni[i] }, function (_, j) {
      return Math.abs(observed[i][j] - meanObserved[i]);
    });
  });
  ...
  var SSB = (0, _simpleStatistics.sum)((0, _from2.default)({ length: c }, function (_, i) {
    return ni[i] * Math.pow(meanZi[i] - meanZ, 2);
  }));
  var SSW = (0, _simpleStatistics.sum)((0, _from2.default)({ length: c }, function (_, i) {
    return (0, _simpleStatistics.sum)((0, _from2.default)({ length: ni[i] }, function (_, j) {
      return Math.pow(Z[i][j] - meanZi[i], 2);
    }));
  }));
  var MSB = SSB / (c - 1);
  var MSW = SSW / (n - c);
...
function BrownForsythe(_ref) {
  ...
  var medianObserved = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _simpleStatistics.median)(observed[i]);
  });
  var Z = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _from2.default)({ length: ni[i] }, function (_, j) {
      return Math.abs(observed[i][j] - medianObserved[i]);
    });
  });
  var sumZi = Z.map(function (_, i) {
    return (0, _simpleStatistics.sum)(Z[i]);
...
function LayardChiSquare(_ref) {
  ...
  var Z = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _from2.default)({ length: ni[i] }, function (_, j) {
      return observed[i][j] - meanObserved[i];
    });
  });
  var SSW = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _simpleStatistics.sum)((0, _from2.default)({ length: ni[i] }, function (_, j) {
      return Math.pow(Z[i][j], 2);
    }));
  });
  var SSSW = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _simpleStatistics.sum)((0, _from2.default)({ length: ni[i] }, function (_, j) {
      return Math.pow(Z[i][j], 4);
    }));
  });
  var gamma = n * (0, _simpleStatistics.sum)(SSSW) / Math.pow((0, _simpleStatistics.sum)(SSW), 2) - 3;
  var T = 2 + (1 - c / n) * gamma;
  var sSqr = (0, _from2.default)({ length: c }, function (_, i) {
    return SSW[i] / c;
  });
  var logsSqr = (0, _from2.default)({ length: c }, function (_, i) {
    return (0, _log2.default)(SSW[i] / c);
  });
  var calc1 = (0, _simpleStatistics.sum)((0, _from2.default)({ length: c }, function (_, i) {
    return (ni[i] - 1) * logsSqr[i];
  })) / (0, _simpleStatistics.sum)((0, _from2.default)({ length: c }, function (_, i) {
    return ni[i] - 1;
  }));
  var calc2 = (0, _from2.default)({ length: c }, function (_, i) {
    return (ni[i] - 1) * Math.pow(logsSqr[i] - calc1, 2);
  });
...
module.exports = __webpack_require__(6).Math.log10;
