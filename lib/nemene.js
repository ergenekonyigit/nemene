...
function ChiSquareGoodnessOfFit(_ref) {
  ...
  var pj = 1 / c;
  var df = c - 1;
  var avg = _util.mean.apply(undefined, (0, _toConsumableArray3.default)(observed));
  var sumObserved = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(observed));
  var expected = (0, _from2.default)({ length: c }, function () {
    return sumObserved * pj;
  });
  var chiSqrCalc = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(expected.map(function (v, i) {
...
function KolmogorovSmirnovGoodnessFit(_ref) {
  ...
  if (typeof mean === 'undefined' && typeof standardDeviation === 'undefined') {
    ...
    mean = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(Xf)) / c;
    ...
    standardDeviation = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(XSubMeanXFrequencyX)) / (c - 1);
  }
...
function Levene(_ref) {
  ...
  var meanObserved = observed.map(function (v) {
    return _util.mean.apply(undefined, (0, _toConsumableArray3.default)(v));
  });
  ...
  var sumZi = Z.map(function (_, i) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(Z[i]));
  });
  var meanZi = sumZi.map(function (v, i) {
    return v / ni[i];
  });
  var meanZ = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(sumZi)) / n;
  var SSB = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(ni.map(function (v, i) {
    return v * Math.pow(meanZi[i] - meanZ, 2);
  })));
  var SSW = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(Z.map(function (v, i) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(v.map(function (val) {
...
function LayardChiSquare(_ref) {
  ...
  var gamma = n * _util.sum.apply(undefined, (0, _toConsumableArray3.default)(SSSW)) / Math.pow(_util.sum.apply(undefined, (0, _toConsumableArray3.default)(SSW)), 2) - 3;
  var T = 2 + (1 - c / n) * gamma;
  ...
  var calc1 = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(ni.map(function (v, i) {
    return (v - 1) * logsSqr[i];
  }))) / _util.sum.apply(undefined, (0, _toConsumableArray3.default)(ni.map(function (v) {
    return v - 1;
  })));
  var calc2 = ni.map(function (v, i) {
    return (v - 1) * Math.pow(logsSqr[i] - calc1, 2);
  });
  var L = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(calc2)) / T;
...
function Binomial(_ref) {
  ...
  var bCalc = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(observed));
...
function OneSampleSign(_ref) {
  ...
  var k = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(delta));
...
function WilcoxonSignedRanks(_ref) {
  ...
  var indexSortedAbsDi = (0, _util.sortArr)(function (_x, _y) {
  ...
  values.forEach(function (item, i) {
    ...
    meanIndice[i] = indexes.map(function (_) {
      return _util.mean.apply(undefined, (0, _toConsumableArray3.default)(indexes));
    });
  });
  ...
  var TPlus = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(rAbsDi.map(function (v, i) {
    return v * delta[i];
  })));
...
function Runs(_ref) {
  ...
  if (observed[0][0]) {
    meanX = _util.mean.apply(undefined, (0, _toConsumableArray3.default)(observed[1]));
    ...
    n = observed.length;
    meanX = _util.mean.apply(undefined, (0, _toConsumableArray3.default)(observed));
...
function LocationMedian(_ref) {
  ...
  var medianXY = (0, _util.median)(sortedXY);
...
function MannWhitney(_ref) {
  ...
  var S = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(rX));
  var T = S - n1 * (n1 + 1) / 2;
...
function FishersExact(_ref) {
  ...
  var a = observed[0][0];
  var b = observed[1][0];
  var n1 = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(observed[0]));
  var n2 = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(observed[1]));
  var n = n1 + n2;
  var w = way === 'one-way' ? 1 : 2;
...
function Mood(_ref) {
  ...
  var M = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(riMinusSqr));
...
function SiegelTukey(_ref) {
  ...
  var ST = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(ai.map(function (v, i) {
    return v * delta[i];
  })));
...
function Sign(_ref) {
  ...
  var kCalc = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(delta));
  var n = delta.length;
  var w = way === 'one-way' ? 1 : 2;
...
function ChiSquareForHomogeneity(_ref) {
  ...
  var sumI = (0, _from2.default)({ length: c }, function (_, i) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(observed.map(function (v) {
      return v[i];
    })));
  });
  var sumJ = observed.map(function (v) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(v));
  });
  var n = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(sumI || sumJ));
  ...
  var chiSqrCalc = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(chiSqr.map(function (v) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(v));
  })));
  var df = (c - 1) * (r - 1);
...
function ChiSquareForIndependence(_ref) {
  ...
  var df = (c - 1) * (r - 1);
  var v = Math.sqrt(chiSqrCalc / (n * (0, _util.min)([c - 1, r - 1])));
  // const pValue = 1 - chiSqrCdf(chiSqrCalc, df);
...
function Median(_ref) {
  ...
  var n = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(ni));
  var flattenObserved = (0, _util.flatten)(observed);
  var m = (0, _util.median)(flattenObserved);
  ...
  var sumI = (0, _from2.default)({ length: nMedianLength[0].length }, function (_, i) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(nMedianLength.map(function (v) {
      return v[i];
    })));
  });
  var sumJ = (0, _from2.default)({ length: nMedianLength.length }, function (_, i) {
    return _util.sum.apply(undefined, (0, _toConsumableArray3.default)(nMedianLength[i]));
  });
...
function KruskalWallis(_ref) {
  ...
  var H = 12 / (n * (n + 1)) * _util.sum.apply(undefined, (0, _toConsumableArray3.default)(Rij.map(function (v, i) {
  ...
  var HStar = H / (1 - _util.sum.apply(undefined, (0, _toConsumableArray3.default)(Ti)) / (Math.pow(n, 3) - n));
...
function SpearmanRankCorrelation(_ref) {
  ...
  var sumDiSqr = _util.sum.apply(undefined, (0, _toConsumableArray3.default)(diSqr));
